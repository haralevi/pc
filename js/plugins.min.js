...
/** @license jquery.panzoom.js v2.0.5 Updated: Mon Feb 01 2016 Add pan and zoom functionality to any element Copyright (c) timmy willison Released under the MIT licensehttps://github.com/timmywil/jquery.panzoom/blob/master/MIT-License.txt */
...
/* jQuery Double Tap Developer: Sergey Margaritov (sergey@margaritov.net) Date: 22.10.2013 Based on jquery documentation http://learn.jquery.com/events/event-extensions/ */
(function(g){g.event.special.doubletap={bindType:"touchend",delegateType:"touchend",handle:function(b){var c=b.handleObj,a=jQuery.data(b.target),d=(new Date).getTime(),e=a.lastTouch?d-a.lastTouch:0,f;e<(null==f?300:f)&&30<e?(a.lastTouch=null,b.type=c.origType,["clientX","clientY","pageX","pageY"].forEach(function(a){b[a]=b.originalEvent.changedTouches[0][a]}),c.handler.apply(this,arguments)):a.lastTouch=d}}})(jQuery);
...
try{if(file.indexOf("uptolike")==-1 && file.indexOf("yandex")==-1 && file.indexOf("leechlink")==-1 && file!=""){
