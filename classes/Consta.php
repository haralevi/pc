...
class Consta
{
    ...
    private static function initVars()
    {
        ...
        if (Config::$domainEnd == 'by') {
            Consta::$FACEBOOK_APP_ID = '1651158191840315';
            Consta::$FACEBOOK_SECRET = '4b60b057908eab468ca06297dd890e3e';
        } else {
            Consta::$FACEBOOK_APP_ID = '124636890950742';
            Consta::$FACEBOOK_SECRET = '90d5ae4096fb38c02b02c1ac482b66c3';
        }
    }
}
