...
class Localizer
{
    ...
    private static $loc_ru = array(
        ...
        'fineart_loc' => 'Художественное фото',
    ...
    private static $loc_en = array(
        'main_title_loc' => 'Photo Community',
        'logout_loc' => 'Logout',
        'login_short_loc' => 'E-mail',
        'pass_loc' => 'Password',
        'enter_short_loc' => 'Login',
        'profile_title_loc' => 'My profile',
        'comm_loc' => 'Сообщения',
        'comm_del_by_admin_loc' => 'Сообщение было удалено администрацией',
        'comm_del_by_author_loc' => 'Сообщение было удалено автором',
        'recomm_works_loc' => 'Рекомендованные работы',
        'all_works_loc' => 'All works',
        'fineart_loc' => 'Fine art',
        'popular_loc' => 'Popular works',
        'critique_works_loc' => 'Работы для критики',
        'works_of_day_loc' => 'Работы дня',
        'friends_works_loc' => 'Работы друзей',
    ...
    private static $loc_de = array(
        ...
        'fineart_loc' => 'Künstlerische Bilder',
    ...
    public static function init()
    {
        if (Config::$lang == 'by') {
            ...
            Localizer::$col_auth_name = 'auth_name_en';
            Localizer::$col_auth_mood = 'auth_mood_en';
            ...
            Localizer::$cat_names = Localizer::$cat_names_en;

            Localizer::$col_port_index_body = 'port_index_body_en';
            Localizer::$col_port_menu_group_name = 'port_menu_group_name_en';
            Localizer::$col_port_title = 'port_title_en';
            Localizer::$col_port_subtitle = 'port_subtitle_en';
            Localizer::$col_port_seo_title = 'port_seo_title_en';
            Localizer::$col_port_seo_desc = 'port_seo_desc_en';
            Localizer::$col_port_seo_keys = 'port_seo_keys_en';

            Localizer::$tbl_ds_comments = 'ds_comments';
            Localizer::$col_auth_name = 'auth_name_en';
            Localizer::$col_auth_mood = 'auth_mood_en';
            Localizer::$col_ph_name = 'ph_name_en';
