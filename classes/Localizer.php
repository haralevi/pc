...
class Localizer
{
    ...
    private static $loc_ru = array(
        ...
        'wrong_login_pass_loc' => 'Неверный логин или пароль',
        'you_redirected_login_again_loc' => 'Вы были перенаправлены<br>введити e-mail и пароль еще раз',
        'site_full_ver_loc' => 'Полная версия сайта',
        'anonymous_loc' => 'Анонимно',
        'work_author_loc' => 'Автор работы',
    ...
    private static $cat_names_by = array(
        100 => 'Человек',
        101 => 'Гламурный портрет',
        102 => 'Классический портрет',
        103 => 'Спонтанный портрет',
    ...
    private static $loc_com = array(
        ...
        'wrong_login_pass_loc' => 'Wrong e-mail or password',
        'you_redirected_login_again_loc' => 'You have been redirected<br>enter e-mail and password one more time',
        'site_full_ver_loc' => 'Desktop version',
        'anonymous_loc' => 'Anonymously',
        'work_author_loc' => 'Author',
    ...
    private static $loc_de = array(
        ...
        'wrong_login_pass_loc' => 'Falscher Login bzw. Passwort',
        'you_redirected_login_again_loc' => 'Sie waren umgeleitet<br>geben Sie biter e-mail and Passwort noch einmal ein',
        'site_full_ver_loc' => 'Desktop-Version',
        'anonymous_loc' => 'Anonym',
        'work_author_loc' => 'Autor',
