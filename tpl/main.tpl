...
<head>
    ...
    <link href="{css_url}default.css?v={css_ver}" rel="stylesheet" type="text/css">
...
<div class="header">
    <div class="wrapContent clearfix">
        <div class="logo">
            <a href="{home_url}index.php"><img srcset="" src="{css_url}{logo_img}" alt=""/></a>
        </div>
...
<div class="footer">
    <div class="wrapContent clearfix">
        <div style="float: left; width: 190px;">
            <a href="{full_ver_url}" class="footerLnk">{site_full_ver_loc}</a>
        </div>
        <div class="prevNext">
